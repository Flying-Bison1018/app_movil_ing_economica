...
void showDialogPressTasaInteres2(
      ...
      return StatefulBuilder(
        builder: (context, setState) {
          void calcularResultado() {
            ...
            resultado = (((valorFinal2/capital2) - 1) / tiempo) * 100;
          }
          ...
          return AlertDialog(
            ...
            content: Container(
              ...
              child: Column(
                children: [
                  const Text("DATOS"),
                  Text("Valor Final: $valorFinal2"),
                  Text("Capital: $capital2"),
                  Text("Tiempo: $tiempo"),
                  const Divider(),
                  Math.tex(
                    "i = \\dfrac{\\dfrac{$valorFinal2}{$capital2} - 1}{${tiempo.toStringAsFixed(1)}}",
                  ),
                  const Divider(),
