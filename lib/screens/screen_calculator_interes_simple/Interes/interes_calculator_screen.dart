...
import 'package:interest_app/widgets/drawers/interes_simple_drawers/Interes/drawer_interes_simple.dart';
import 'package:interest_app/widgets/interes_simple_widgets/Interes/showdialogwidget_interes_calculator.dart';
...
class InteresCalculator extends StatefulWidget {
  const InteresCalculator({super.key});

  @override
  State<InteresCalculator> createState() => _InteresCalculatorState();
}

class _InteresCalculatorState extends State<InteresCalculator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("CALCULAR INTERES"),
          centerTitle: true,
          leading: IconButton(
              onPressed: () {
