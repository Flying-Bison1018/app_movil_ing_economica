...
import 'package:interest_app/widgets/interes_simple_widgets/TasaInteres/showdialogwidget_tasa_interes_calculator2.dart';
import 'package:interest_app/widgets/textfromfield.dart';

class TasaInteresCalculator2 extends StatefulWidget {
  const TasaInteresCalculator2({super.key});

  @override
  State<TasaInteresCalculator2> createState() => _TasaInteresCalculator2State();
}

class _TasaInteresCalculator2State extends State<TasaInteresCalculator2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("CALCULAR TASA INTERES 2"),
        centerTitle: true,
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            if (error == true) {
                              ...
                              var valorFinalSinComaNiPunto = valorFinal
                                  .replaceAll(".0", "")
                                  .replaceAll(",", "");
                              valorFinal = valorFinalSinComaNiPunto;

                              showDialogPressTasaInteres2(
                                  context,
                                  valorFinal,
                                  capital,
                                  _btnSelected,
